package cn.agriculture.utils.canal.java.com.alibaba.otter.canal.client.impl;
...
public class ClusterCanalConnector implements CanalConnector {
    ...
    private com.alibaba.otter.canal.client.impl.SimpleCanalConnector currentConnector;
    ...
    public void connect() throws CanalClientException {
        while (currentConnector == null) {
            ...
            while (true) {
                try {
                    currentConnector = new com.alibaba.otter.canal.client.impl.SimpleCanalConnector(null, username, password, destination) {
