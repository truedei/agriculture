...
public class CanalConnectors {
     ...
     * @return
     */
    public static com.alibaba.otter.canal.client.CanalConnector newSingleConnector(SocketAddress address, String destination, String username,
                                                                                   String password) {
     ...
     * @return
     */
    public static com.alibaba.otter.canal.client.CanalConnector newClusterConnector(List<? extends SocketAddress> addresses, String destination,
